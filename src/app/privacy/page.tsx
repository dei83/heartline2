...
export const metadata: Metadata = {
    ...
    description: "Privacy Policy for Heartline CRM.",
    robots: {
        index: false,
        follow: true,
    }
...
export default function PrivacyPage() {
    return (
        <div className="container mx-auto py-12 px-4 max-w-3xl prose dark:prose-invert">
            ...
            <p>
                At Heartline, accessible from https://heartline.app, one of our main priorities is the privacy of our visitors.
                This Privacy Policy document contains types of information that is collected and recorded by Heartline and how we use it.
            </p>

            <h2>Log Files</h2>
            <p>
                Heartline follows a standard procedure of using log files. These files log visitors when they visit websites.
            ...
            <p>
                Like any other website, Heartline uses 'cookies'. These cookies are used to store information including visitors' preferences,
